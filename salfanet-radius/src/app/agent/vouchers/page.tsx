    ...
    <div className="p-4 lg:p-6">
      ...
      <div className="bg-white/80 dark:bg-[#0a0520]/80 backdrop-blur-xl rounded-2xl border-2 border-purple-300 dark:border-[#bc13fe]/30 overflow-hidden shadow-[0_0_30px_rgba(188,19,254,0.15)]">
        ...
        {pagination.totalPages > 1 && (
          <div className="px-5 py-3 border-t border-purple-200 dark:border-[#bc13fe]/20 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="p-1.5 rounded hover:bg-purple-50 dark:hover:bg-[#bc13fe]/10 disabled:opacity-50 disabled:cursor-not-allowed"
              >
