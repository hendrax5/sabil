...
COPY ./salfanet-radius/freeradius-config/mods-available/rest /etc/raddb/mods-available/rest
COPY ./salfanet-radius/freeradius-config/mods-available/mschap /etc/raddb/mods-available/mschap
COPY ./salfanet-radius/freeradius-config/sites-available/default /etc/raddb/sites-available/default
COPY ./salfanet-radius/freeradius-config/sites-available/coa /etc/raddb/sites-available/coa
COPY ./salfanet-radius/freeradius-config/policy.d/filter /etc/raddb/policy.d/filter
...
# Ensure all modules and virtual sites are actively enabled
